    ...
    <div className='form-container' id='contactus'>
        ...
        <div className="form-left">
            ...
            <div className="contact-info">
                ...
                <p>A108 Adam StreetHalifax, Nova ScotiaCanada</p>
            </div>
            <div className="contact-info">
                <div className="contact-img">
        ...
        <div className="form-right">
            ...
            <div className="form-row"><input type="text" placeholder='Email Address' /></div>
            <div className="form-row"><input type="text" placeholder='Tell about your project' value={`I am interested in ${form} Package,`} /></div>
