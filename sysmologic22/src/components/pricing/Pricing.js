  ...
  return (
    <div className='pricing-container' id='pricing'>
        ...
        <div className="pricing-con unfocused">
            ...
            <a href='#contactus' className="select" onClick={()=>{setForm('Basic Website')}}  >
            Select
            </a>
        ...
        <div className="pricing-con focused">
            ...
            <a href='#contactus' className="select yellow-select" onClick={()=>{setForm('Modern Website')}}  >
            Select
            </a>
            <div className="features">
        ...
        <div className="pricing-con unfocused">
            ...
            <a href='#contactus' className="select" onClick={()=>{setForm('Full Stack Website')}}  >
            Select
            </a>
            <div className="features">
